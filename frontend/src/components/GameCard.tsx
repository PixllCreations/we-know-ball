        ...
        <div className="mt-3 border-t border-border/60 pt-3">
          <Dialog>
            <DialogTrigger asChild>
              <button
                type="button"
                className="w-full rounded-md border border-primary/40 bg-primary/10 px-3 py-2 text-xs font-mono uppercase tracking-wider text-primary transition-colors hover:bg-primary/15"
